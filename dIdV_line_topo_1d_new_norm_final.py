...
class DidVLineAnalyzer:
    ...
    def plot_line_with_topo_interactive(self, hampel_filter_params=None,
        ...
        self._int_topo_raw = topo_profile[::1].copy()  # reverse to match pos ordering
...
if __name__ == '__main__':
    ...
    analyzer = DidVLineAnalyzer('C:/dir/file.sm4', chunk_index=1, cmap='jet', scalefactor=2.75, scan_mode='single', combine_scans=False)
    ...
    analyzer.plot_line_with_topo_interactive(
        ...
        topo_lines=[(1, 'forward')])        # or e.g. [(0, 'forward'), (1, 'reverse')]